...
function initParse(){
        ...
        testObject.save(
            {prueba: navigator.userAgent, coment:comentario, posicion:miPos, feliz:feliz, fecha:fecha },
            {success: parseado(), error: function(model, error) {console.log("conexion fallida");alert("fallida.")} });
}


function handleNoGeolocation(errorFlag) {///  NO GEO!!!
        console.log("fail");
        if (errorFlag) {
...
function mapea() {///////////////////////////////////////////////////////////////////////// mapea
    ...
    if(navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition(function(position) {
            ...
            miPos=new google.maps.LatLng(position.coords.longitude, position.coords.latitude);
